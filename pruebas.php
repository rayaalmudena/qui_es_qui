		...
		if (errores()!=true) {
			...
			function cartaElegida($cartas){
				...
				if( !isset($_SESSION)){
					...
					$_SESSION["elegidasesion"] = $Elegida;
					echo $Elegida;
				}
				else{
					echo $_SESSION["elegidasesion"];
				}
			...
			if( !isset($_SESSION)){
				...
				$_SESSION["tablerosesion"] = tableroCartas($arrayTablero);
				...
				$_SESSION["nombre_carta_sesion"] = $nombre_carta;
				$_SESSION["gafas_carta_sesion"] = $gafas_carta;
				$_SESSION["cabello_carta_sesion"] = $cabello_carta;
				$_SESSION["sexo_carta_sesion"] = $sexo_carta;

				//Este echo se utiliza para guardar o enviar variables entre el php y el javascript.
				$_SESSION["nombre_php-js_sesion"] = "<p id='nombre_php-js' hidden>$nombre_carta</p>
				...
				echo $_SESSION["tablerosesion"];

				echo $_SESSION["nombre_carta_sesion"];
				echo $_SESSION["gafas_carta_sesion"];
				echo $_SESSION["cabello_carta_sesion"];
				echo $_SESSION["sexo_carta_sesion"];
				echo $_SESSION["nombre_php-js_sesion"];
